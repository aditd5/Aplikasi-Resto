...
Public Class NotaPenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiResto0591.NotaPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kembali() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedNotaPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaPenjualan = New NotaPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
