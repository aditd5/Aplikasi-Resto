Public Class FormKategori
    ...
    Private Sub DGKategori_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGKategori.CellClick
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        status_referensi = KontrolKategori.CekKategoriDirefernsi(txtIDKategori.Text)
